        ...
        do {
            ...
            switch (opcion) {
                case "jugar":
                    ...
                    System.out.println("\n*******************************");
                    System.out.println("USUARIO = " + eleccionUsu);
                    System.out.println("MAQUINA = " + eleccionMaq);
                    System.out.println("*******************************\n");
            ...
            do {                
                try {
                    ...
                    if (dedosUsu < 0 || dedosUsu > 10) {
                        System.out.println("ESCRIBE BIEN LOS DEDOS GIL\n");
                    }
                    repetir = true;
                    
                } catch (InputMismatchException ife) {
                    System.out.println("ESCRIBA UN NUMERO CATETO");
                }
